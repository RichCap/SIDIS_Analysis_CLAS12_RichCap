...
def variable_Title_name(variable):
    ...
    if("z_pT_phi_t_3D_Bin_Valerii"       in variable):
        output  =  "Valerii's 3D Kinematic Bins (z+P_{T}+#phi_{h})"
    ...
    if(variable == "exclusive_rho_full"):
        output  = "(Full) Conditions for Exclusive #rho^{0}"
...
Bin_Definition_Array = {
    ...
    'Q2-y=3, z-pT=1': [0.72, 0.56, 0.2, 0.05], 'Q2-y=3, z-pT=2': [0.72, 0.56, 0.3, 0.2], 'Q2-y=3, z-pT=3': [0.72, 0.56, 0.39, 0.3], 'Q2-y=3, z-pT=4': [0.72, 0.56, 0.49, 0.39], 'Q2-y=3, z-pT=5': [0.72, 0.56, 0.59, 0.49], 'Q2-y=3, z-pT=6': [0.72, 0.56, 0.76, 0.59], 'Q2-y=3, z-pT=7': [0.56, 0.41, 0.2, 0.05], 'Q2-y=3, z-pT=8': [0.56, 0.41, 0.3, 0.2], 'Q2-y=3, z-pT=9': [0.56, 0.41, 0.39, 0.3], 'Q2-y=3, z-pT=10': [0.56, 0.41, 0.49, 0.39], 'Q2-y=3, z-pT=11': [0.56, 0.41, 0.59, 0.49], 'Q2-y=3, z-pT=12': [0.56, 0.41, 0.76, 0.59], 'Q2-y=3, z-pT=13': [0.41, 0.33, 0.2, 0.05], 'Q2-y=3, z-pT=14': [0.41, 0.33, 0.3, 0.2], 'Q2-y=3, z-pT=15': [0.41, 0.33, 0.39, 0.3], 'Q2-y=3, z-pT=16': [0.41, 0.33, 0.49, 0.39], 'Q2-y=3, z-pT=17': [0.41, 0.33, 0.59, 0.49], 'Q2-y=3, z-pT=18': [0.41, 0.33, 0.76, 0.59], 'Q2-y=3, z-pT=19': [0.33, 0.28, 0.2, 0.05], 'Q2-y=3, z-pT=20': [0.33, 0.28, 0.3, 0.2], 'Q2-y=3, z-pT=21': [0.33, 0.28, 0.39, 0.3], 'Q2-y=3, z-pT=22': [0.33, 0.28, 0.49, 0.39], 'Q2-y=3, z-pT=23': [0.33, 0.28, 0.59, 0.49], 'Q2-y=3, z-pT=24': [0.33, 0.28, 0.76, 0.59], 'Q2-y=3, z-pT=25': [0.28, 0.22, 0.2, 0.05], 'Q2-y=3, z-pT=26': [0.28, 0.22, 0.3, 0.2], 'Q2-y=3, z-pT=27': [0.28, 0.22, 0.39, 0.3], 'Q2-y=3, z-pT=28': [0.28, 0.22, 0.49, 0.39], 'Q2-y=3, z-pT=29': [0.28, 0.22, 0.59, 0.49], 'Q2-y=3, z-pT=30 - REMOVE - MIGRATION BIN': [0.28, 0.22, 0.76, 0.59],
    'Q2-y=4, z-pT=1': [0.71, 0.59, 0.2, 0.05], 'Q2-y=4, z-pT=2': [0.71, 0.59, 0.29, 0.2], 'Q2-y=4, z-pT=3': [0.71, 0.59, 0.38, 0.29], 'Q2-y=4, z-pT=4': [0.71, 0.59, 0.48, 0.38], 'Q2-y=4, z-pT=5': [0.71, 0.59, 0.61, 0.48], 'Q2-y=4, z-pT=6 - REMOVE - MIGRATION BIN': [0.71, 0.59, 0.7, 0.61], 'Q2-y=4, z-pT=7': [0.59, 0.5, 0.2, 0.05], 'Q2-y=4, z-pT=8': [0.59, 0.5, 0.29, 0.2], 'Q2-y=4, z-pT=9': [0.59, 0.5, 0.38, 0.29], 'Q2-y=4, z-pT=10': [0.59, 0.5, 0.48, 0.38], 'Q2-y=4, z-pT=11': [0.59, 0.5, 0.61, 0.48], 'Q2-y=4, z-pT=12': [0.59, 0.5, 0.7, 0.61], 'Q2-y=4, z-pT=13': [0.5, 0.43, 0.2, 0.05], 'Q2-y=4, z-pT=14': [0.5, 0.43, 0.29, 0.2], 'Q2-y=4, z-pT=15': [0.5, 0.43, 0.38, 0.29], 'Q2-y=4, z-pT=16': [0.5, 0.43, 0.48, 0.38], 'Q2-y=4, z-pT=17': [0.5, 0.43, 0.61, 0.48], 'Q2-y=4, z-pT=18': [0.5, 0.43, 0.7, 0.61], 'Q2-y=4, z-pT=19': [0.43, 0.38, 0.2, 0.05], 'Q2-y=4, z-pT=20': [0.43, 0.38, 0.29, 0.2], 'Q2-y=4, z-pT=21': [0.43, 0.38, 0.38, 0.29], 'Q2-y=4, z-pT=22': [0.43, 0.38, 0.48, 0.38], 'Q2-y=4, z-pT=23': [0.43, 0.38, 0.61, 0.48], 'Q2-y=4, z-pT=24': [0.43, 0.38, 0.7, 0.61], 'Q2-y=4, z-pT=25': [0.38, 0.33, 0.2, 0.05], 'Q2-y=4, z-pT=26': [0.38, 0.33, 0.29, 0.2], 'Q2-y=4, z-pT=27': [0.38, 0.33, 0.38, 0.29], 'Q2-y=4, z-pT=28': [0.38, 0.33, 0.48, 0.38], 'Q2-y=4, z-pT=29': [0.38, 0.33, 0.61, 0.48], 'Q2-y=4, z-pT=30 - REMOVE - MIGRATION BIN': [0.38, 0.33, 0.7, 0.61], 'Q2-y=4, z-pT=31': [0.33, 0.26, 0.2, 0.05], 'Q2-y=4, z-pT=32': [0.33, 0.26, 0.29, 0.2], 'Q2-y=4, z-pT=33': [0.33, 0.26, 0.38, 0.29], 'Q2-y=4, z-pT=34': [0.33, 0.26, 0.48, 0.38], 'Q2-y=4, z-pT=35': [0.33, 0.26, 0.61, 0.48], 'Q2-y=4, z-pT=36 - REMOVE - MIGRATION BIN': [0.33, 0.26, 0.7, 0.61],
    'Q2-y=5, z-pT=1': [0.72, 0.49, 0.22, 0.05], 'Q2-y=5, z-pT=2': [0.72, 0.49, 0.32, 0.22], 'Q2-y=5, z-pT=3': [0.72, 0.49, 0.41, 0.32], 'Q2-y=5, z-pT=4': [0.72, 0.49, 0.51, 0.41], 'Q2-y=5, z-pT=5': [0.72, 0.49, 0.65, 0.51], 'Q2-y=5, z-pT=6': [0.72, 0.49, 0.98, 0.65], 'Q2-y=5, z-pT=7': [0.49, 0.38, 0.22, 0.05], 'Q2-y=5, z-pT=8': [0.49, 0.38, 0.32, 0.22], 'Q2-y=5, z-pT=9': [0.49, 0.38, 0.41, 0.32], 'Q2-y=5, z-pT=10': [0.49, 0.38, 0.51, 0.41], 'Q2-y=5, z-pT=11': [0.49, 0.38, 0.65, 0.51], 'Q2-y=5, z-pT=12': [0.49, 0.38, 0.98, 0.65], 'Q2-y=5, z-pT=13': [0.38, 0.3, 0.22, 0.05], 'Q2-y=5, z-pT=14': [0.38, 0.3, 0.32, 0.22], 'Q2-y=5, z-pT=15': [0.38, 0.3, 0.41, 0.32], 'Q2-y=5, z-pT=16': [0.38, 0.3, 0.51, 0.41], 'Q2-y=5, z-pT=17': [0.38, 0.3, 0.65, 0.51], 'Q2-y=5, z-pT=18': [0.38, 0.3, 0.98, 0.65], 'Q2-y=5, z-pT=19': [0.3, 0.24, 0.22, 0.05], 'Q2-y=5, z-pT=20': [0.3, 0.24, 0.32, 0.22], 'Q2-y=5, z-pT=21': [0.3, 0.24, 0.41, 0.32], 'Q2-y=5, z-pT=22': [0.3, 0.24, 0.51, 0.41], 'Q2-y=5, z-pT=23': [0.3, 0.24, 0.65, 0.51], 'Q2-y=5, z-pT=24 - REMOVE - MIGRATION BIN': [0.3, 0.24, 0.98, 0.65], 'Q2-y=5, z-pT=25': [0.24, 0.2, 0.22, 0.05], 'Q2-y=5, z-pT=26': [0.24, 0.2, 0.32, 0.22], 'Q2-y=5, z-pT=27': [0.24, 0.2, 0.41, 0.32], 'Q2-y=5, z-pT=28': [0.24, 0.2, 0.51, 0.41], 'Q2-y=5, z-pT=29': [0.24, 0.2, 0.65, 0.51], 'Q2-y=5, z-pT=30 - REMOVE - MIGRATION BIN': [0.24, 0.2, 0.98, 0.65], 'Q2-y=5, z-pT=31': [0.2, 0.16, 0.22, 0.05], 'Q2-y=5, z-pT=32': [0.2, 0.16, 0.32, 0.22], 'Q2-y=5, z-pT=33': [0.2, 0.16, 0.41, 0.32], 'Q2-y=5, z-pT=34': [0.2, 0.16, 0.51, 0.41], 'Q2-y=5, z-pT=35 - REMOVE - MIGRATION BIN': [0.2, 0.16, 0.65, 0.51], 'Q2-y=5, z-pT=36 - REMOVE - MIGRATION BIN': [0.2, 0.16, 0.98, 0.65],
    'Q2-y=6, z-pT=1': [0.72, 0.45, 0.22, 0.05], 'Q2-y=6, z-pT=2': [0.72, 0.45, 0.32, 0.22], 'Q2-y=6, z-pT=3': [0.72, 0.45, 0.41, 0.32], 'Q2-y=6, z-pT=4': [0.72, 0.45, 0.51, 0.41], 'Q2-y=6, z-pT=5': [0.72, 0.45, 0.65, 0.51], 'Q2-y=6, z-pT=6': [0.72, 0.45, 1, 0.65], 'Q2-y=6, z-pT=7': [0.45, 0.35, 0.22, 0.05], 'Q2-y=6, z-pT=8': [0.45, 0.35, 0.32, 0.22], 'Q2-y=6, z-pT=9': [0.45, 0.35, 0.41, 0.32], 'Q2-y=6, z-pT=10': [0.45, 0.35, 0.51, 0.41], 'Q2-y=6, z-pT=11': [0.45, 0.35, 0.65, 0.51], 'Q2-y=6, z-pT=12': [0.45, 0.35, 1, 0.65], 'Q2-y=6, z-pT=13': [0.35, 0.28, 0.22, 0.05], 'Q2-y=6, z-pT=14': [0.35, 0.28, 0.32, 0.22], 'Q2-y=6, z-pT=15': [0.35, 0.28, 0.41, 0.32], 'Q2-y=6, z-pT=16': [0.35, 0.28, 0.51, 0.41], 'Q2-y=6, z-pT=17': [0.35, 0.28, 0.65, 0.51], 'Q2-y=6, z-pT=18 - REMOVE - MIGRATION BIN': [0.35, 0.28, 1, 0.65], 'Q2-y=6, z-pT=19': [0.28, 0.23, 0.22, 0.05], 'Q2-y=6, z-pT=20': [0.28, 0.23, 0.32, 0.22], 'Q2-y=6, z-pT=21': [0.28, 0.23, 0.41, 0.32], 'Q2-y=6, z-pT=22': [0.28, 0.23, 0.51, 0.41], 'Q2-y=6, z-pT=23': [0.28, 0.23, 0.65, 0.51], 'Q2-y=6, z-pT=24 - REMOVE - MIGRATION BIN': [0.28, 0.23, 1, 0.65], 'Q2-y=6, z-pT=25': [0.23, 0.18, 0.22, 0.05], 'Q2-y=6, z-pT=26': [0.23, 0.18, 0.32, 0.22], 'Q2-y=6, z-pT=27': [0.23, 0.18, 0.41, 0.32], 'Q2-y=6, z-pT=28': [0.23, 0.18, 0.51, 0.41], 'Q2-y=6, z-pT=29 - REMOVE - MIGRATION BIN': [0.23, 0.18, 0.65, 0.51], 'Q2-y=6, z-pT=30 - REMOVE - MIGRATION BIN': [0.23, 0.18, 1, 0.65],
    'Q2-y=7, z-pT=1': [0.69, 0.58, 0.2, 0.05], 'Q2-y=7, z-pT=2': [0.69, 0.58, 0.29, 0.2], 'Q2-y=7, z-pT=3': [0.69, 0.58, 0.38, 0.29], 'Q2-y=7, z-pT=4': [0.69, 0.58, 0.48, 0.38], 'Q2-y=7, z-pT=5': [0.69, 0.58, 0.6, 0.48], 'Q2-y=7, z-pT=6 - REMOVE - MIGRATION BIN': [0.69, 0.58, 0.83, 0.6], 'Q2-y=7, z-pT=7': [0.58, 0.45, 0.2, 0.05], 'Q2-y=7, z-pT=8': [0.58, 0.45, 0.29, 0.2], 'Q2-y=7, z-pT=9': [0.58, 0.45, 0.38, 0.29], 'Q2-y=7, z-pT=10': [0.58, 0.45, 0.48, 0.38], 'Q2-y=7, z-pT=11': [0.58, 0.45, 0.6, 0.48], 'Q2-y=7, z-pT=12': [0.58, 0.45, 0.83, 0.6], 'Q2-y=7, z-pT=13': [0.45, 0.37, 0.2, 0.05], 'Q2-y=7, z-pT=14': [0.45, 0.37, 0.29, 0.2], 'Q2-y=7, z-pT=15': [0.45, 0.37, 0.38, 0.29], 'Q2-y=7, z-pT=16': [0.45, 0.37, 0.48, 0.38], 'Q2-y=7, z-pT=17': [0.45, 0.37, 0.6, 0.48], 'Q2-y=7, z-pT=18': [0.45, 0.37, 0.83, 0.6], 'Q2-y=7, z-pT=19': [0.37, 0.31, 0.2, 0.05], 'Q2-y=7, z-pT=20': [0.37, 0.31, 0.29, 0.2], 'Q2-y=7, z-pT=21': [0.37, 0.31, 0.38, 0.29], 'Q2-y=7, z-pT=22': [0.37, 0.31, 0.48, 0.38], 'Q2-y=7, z-pT=23': [0.37, 0.31, 0.6, 0.48], 'Q2-y=7, z-pT=24': [0.37, 0.31, 0.83, 0.6], 'Q2-y=7, z-pT=25': [0.31, 0.27, 0.2, 0.05], 'Q2-y=7, z-pT=26': [0.31, 0.27, 0.29, 0.2], 'Q2-y=7, z-pT=27': [0.31, 0.27, 0.38, 0.29], 'Q2-y=7, z-pT=28': [0.31, 0.27, 0.48, 0.38], 'Q2-y=7, z-pT=29': [0.31, 0.27, 0.6, 0.48], 'Q2-y=7, z-pT=30 - REMOVE - MIGRATION BIN': [0.31, 0.27, 0.83, 0.6], 'Q2-y=7, z-pT=31': [0.27, 0.22, 0.2, 0.05], 'Q2-y=7, z-pT=32': [0.27, 0.22, 0.29, 0.2], 'Q2-y=7, z-pT=33': [0.27, 0.22, 0.38, 0.29], 'Q2-y=7, z-pT=34': [0.27, 0.22, 0.48, 0.38], 'Q2-y=7, z-pT=35': [0.27, 0.22, 0.6, 0.48], 'Q2-y=7, z-pT=36 - REMOVE - MIGRATION BIN': [0.27, 0.22, 0.83, 0.6],
...
Common_Ranges_for_Integrating_z_pT_Bins = {
     '1': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '8', '9', '10', '15', '16', '17'],
     '2': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15', '19', '20', '21'],
     '3': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15', '19', '20', '21'],
     '4': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15', '19', '20', '21', '25', '26', '27'],
     '5': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15', '19', '20', '21'],
     '6': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15'],
     '7': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15', '19', '20', '21', '25', '26', '27'],
     '8': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '4', '6',  '7',  '8',  '9', '11', '12', '13', '14', '16', '17', '18', '19', '21', '22', '23', '24', '26', '27', '28', '29', '31', '32', '33', '34'],
     '9': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '4', '8',  '9', '10', '11', '15', '16', '17', '18'],
    '10': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15', '19', '20', '21'],
    '11': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '6', '7',  '8', '11', '12', '13', '16', '17', '18'],
    '12': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '4', '6',  '7',  '8',  '9', '11', '12', '13', '14', '16', '17', '18', '19', '21', '22', '23', '24'],
    '13': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '6', '7',  '8', '11', '12', '13', '16', '17', '18'],
    '14': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15', '19', '20', '21'],
    '15': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '6', '7',  '8', '11', '12', '13', '16', '17', '18'],
    '16': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '7', '8',  '9', '13', '14', '15'],
    '17': ['Common_Int', '-2', 'All', '0', '1', '2', '3', '4', '7',  '8',  '9', '10', '13', '14', '15', '16'],
}
...
def skip_condition_z_pT_bins(Q2_Y_BIN, Z_PT_BIN, BINNING_METHOD="_Y_bin", Common_z_pT_Range_Q=False):
    if(Common_z_pT_Range_Q):
        ...
        # skip_condition_Y_bins_return = skip_condition_Y_bins_return or  (((Q2_Y_BIN in [4])          and (Z_PT_BIN in [1, 2, 3, 4, 5, 12, 24])))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or  (((Q2_Y_BIN in [4])          and (Z_PT_BIN in [1, 2, 3, 4, 5, 12, 18, 30])))
        # skip_condition_Y_bins_return = skip_condition_Y_bins_return or  (((Q2_Y_BIN in [5])          and (Z_PT_BIN in [30, 36])))
        # skip_condition_Y_bins_return = skip_condition_Y_bins_return or  (((Q2_Y_BIN in [6])          and (Z_PT_BIN in [30])))
        # skip_condition_Y_bins_return = skip_condition_Y_bins_return or  (((Q2_Y_BIN in [7])          and (Z_PT_BIN in [24, 30])))
        ...
        # skip_condition_Y_bins_return = skip_condition_Y_bins_return or  (((Q2_Y_BIN in [13, 14])     and (Z_PT_BIN in [25])))
        # skip_condition_Y_bins_return = skip_condition_Y_bins_return or  (((Q2_Y_BIN in [15, 16, 17]) and (Z_PT_BIN in [20])))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [3])  and (Z_PT_BIN in [6]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [11]) and (Z_PT_BIN in [5]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [14]) and (Z_PT_BIN in [6]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [17]) and (Z_PT_BIN in [6]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [4])  and (Z_PT_BIN in [11]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [8])  and (Z_PT_BIN in [10]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [12]) and (Z_PT_BIN in [10]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [7])  and (Z_PT_BIN in [5]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [8])  and (Z_PT_BIN in [9, 15]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [12]) and (Z_PT_BIN in [9, 15]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [15]) and (Z_PT_BIN in [3, 4, 10]))
        skip_condition_Y_bins_return = skip_condition_Y_bins_return or ((Q2_Y_BIN in [17]) and (Z_PT_BIN in [5]))
        return skip_condition_Y_bins_return
    else:
        return False
