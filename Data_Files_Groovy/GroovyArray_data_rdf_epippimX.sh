#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=Data_epippimX_data_1_22_2026
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/TEMP_Paths_to_REAL_Data_files_wPim.txt"
GROOVY_SCRIPT="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/REAL_Data/Data_TTree_epip_Pim_Batch_Pass2.groovy"
