#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=Data_eppipX_data_12_23_2025
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/Paths_to_REAL_Data_files_all.txt"
