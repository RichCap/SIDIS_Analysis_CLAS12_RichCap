#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=MC_Gen_epippimX_clasdis_1_22_2026
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/TEMP_GEN_Paths_to_MC_clasdis_files_wPim.txt"
GROOVY_SCRIPT="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/GEN_MC/MC_Gen_TTree_epip_Pim_Batch_Pass2_UpToDate.groovy"
