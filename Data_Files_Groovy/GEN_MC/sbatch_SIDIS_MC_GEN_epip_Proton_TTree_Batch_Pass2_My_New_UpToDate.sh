#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=PMy_GEN_sidis_epip_Proton_TTree_7_29_2024_P2_WithPionCount_R1
...
FILES=(/w/hallb-scshelf2102/clas12/richcap/SIDIS/New_MC_hipo/BeamEnergy_1060/inb-clasdis*)
