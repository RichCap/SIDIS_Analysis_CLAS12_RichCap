#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=PMy_GEN_sidis_epip_Proton_TTree_8_22_2024_P2_WithPionCount_R1
...
FILES=(/lustre24/expphy/volatile/clas12/richcap/New_MC_SIDIS_Files_Volatile/inb-clasdis-80*)
