...
// As of 1/18/2026:
// def ff = new ROOTFile("MC_Matching_sidis_epip_richcap.${suff}.wPim.new7.${outname}.root")

// As of 8/26/2026: new10 requires reciprocal MC::RecMatch/MC::GenMatch bank matching
def ff = new ROOTFile("MC_Matching_sidis_epip_richcap.${suff}.wPim.new10.${outname}.root")
