...
def ff = new ROOTFile("MC_Matching_sidis_epip_richcap.${suff}.rho0.new10.${outname}.root")
...
def matchToGenerated(def MCpart,           def lund,  def list_of_matched_particles_gen_pip,
    ...
    if(pid_matched_pip != 0){ 
        ...
        } else { parentPID_pi = findParentPIDFromLund(lund, pid_matched_pip, matched_pip_x_gen, matched_pip_y_gen, matched_pip_z_gen, ABS_TOL, REL_TOL); }
    }
                ...
                for(int ipart = 1; ipart < partb.getRows(); ipart++){
                    ...
                    if(pip_pion_PIDs.Min_PID_check){
                        ...
                        if(match_bankP.pid_matched != 0){
                            ...
                            rho0_parent_Bank = parent_of_pip_bank.rho0_parent
                        }
