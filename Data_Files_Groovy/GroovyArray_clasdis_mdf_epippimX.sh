#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=MC_Rec_epippimX_clasdis_1_22_2026
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/TEMP_Paths_to_MC_clasdis_files_wPim.txt"
GROOVY_SCRIPT="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/Matched_REC_MC/MC_Matched_TTree_epip_Pim_Batch_New.groovy"
