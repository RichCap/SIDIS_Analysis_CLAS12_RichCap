#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=MC_Rec_epipX_evgen_1_22_2026
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/TEMP_Paths_to_MC_EvGen_files_SIDIS.txt"
GROOVY_SCRIPT="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/Matched_REC_MC/MC_Matched_EvGen_epip_Batch.groovy"
