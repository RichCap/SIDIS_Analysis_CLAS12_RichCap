#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=No_Cut_MC_Rec_epipX_clasdis_4_22_2026
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/TEMP_Paths_to_MC_clasdis_files_SIDIS.txt"
