#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=MC_Rec_epipX_clasdis_8_28_2026
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/TEMP_Q2_Cut_50nA_Paths_to_MC_clasdis_files_SIDIS.txt"
GROOVY_SCRIPT="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/Matched_REC_MC/MC_Matched_TTree_epip_Batch_New.groovy"
