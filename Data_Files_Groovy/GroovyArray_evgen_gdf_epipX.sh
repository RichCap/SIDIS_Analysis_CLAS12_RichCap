#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=MC_Gen_epipX_evgen_12_23_2025
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/Paths_to_MC_EvGen_files_all.txt"
