#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=MC_Rec_eppipX_clasdis_1_22_2026
...
MANIFEST="/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/Data_Files_Groovy/TEMP_Paths_to_MC_clasdis_files_wProton.txt"
