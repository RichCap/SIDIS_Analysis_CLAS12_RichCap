...
z_pT_Bin_Borders[3][1][0]   = 0.72;	z_pT_Bin_Borders[3][1][1]   = 0.56;	z_pT_Bin_Borders[3][1][2]   = 0.2;	z_pT_Bin_Borders[3][1][3]   = 0.05;	Phi_h_Bin_Values[3][1][0]   =  24;	Phi_h_Bin_Values[3][1][1]   = 0;	Phi_h_Bin_Values[3][1][2]   = 1474;
z_pT_Bin_Borders[3][2][0]   = 0.72;	z_pT_Bin_Borders[3][2][1]   = 0.56;	z_pT_Bin_Borders[3][2][2]   = 0.3;	z_pT_Bin_Borders[3][2][3]   = 0.2;	Phi_h_Bin_Values[3][2][0]   =  24;	Phi_h_Bin_Values[3][2][1]   = 24;	Phi_h_Bin_Values[3][2][2]   = 1498;
z_pT_Bin_Borders[3][3][0]   = 0.72;	z_pT_Bin_Borders[3][3][1]   = 0.56;	z_pT_Bin_Borders[3][3][2]   = 0.39;	z_pT_Bin_Borders[3][3][3]   = 0.3;	Phi_h_Bin_Values[3][3][0]   =  24;	Phi_h_Bin_Values[3][3][1]   = 48;	Phi_h_Bin_Values[3][3][2]   = 1522;
z_pT_Bin_Borders[3][4][0]   = 0.72;	z_pT_Bin_Borders[3][4][1]   = 0.56;	z_pT_Bin_Borders[3][4][2]   = 0.49;	z_pT_Bin_Borders[3][4][3]   = 0.39;	Phi_h_Bin_Values[3][4][0]   =  24;	Phi_h_Bin_Values[3][4][1]   = 72;	Phi_h_Bin_Values[3][4][2]   = 1546;
z_pT_Bin_Borders[3][5][0]   = 0.72;	z_pT_Bin_Borders[3][5][1]   = 0.56;	z_pT_Bin_Borders[3][5][2]   = 0.59;	z_pT_Bin_Borders[3][5][3]   = 0.49;	Phi_h_Bin_Values[3][5][0]   =  24;	Phi_h_Bin_Values[3][5][1]   = 96;	Phi_h_Bin_Values[3][5][2]   = 1570;
z_pT_Bin_Borders[3][6][0]   = 0.72;	z_pT_Bin_Borders[3][6][1]   = 0.56;	z_pT_Bin_Borders[3][6][2]   = 0.76;	z_pT_Bin_Borders[3][6][3]   = 0.59;	Phi_h_Bin_Values[3][6][0]   =  24;	Phi_h_Bin_Values[3][6][1]   = 120;	Phi_h_Bin_Values[3][6][2]   = 1594;
...
z_pT_Bin_Borders[4][6][0]   = 0.71;	z_pT_Bin_Borders[4][6][1]   = 0.59;	z_pT_Bin_Borders[4][6][2]   = 0.70;	z_pT_Bin_Borders[4][6][3]   = 0.61;	Phi_h_Bin_Values[4][6][0]   =  1;	Phi_h_Bin_Values[4][6][1]   = 120;	Phi_h_Bin_Values[4][6][2]   = 2291;
...
z_pT_Bin_Borders[4][12][0]  = 0.59;	z_pT_Bin_Borders[4][12][1]  = 0.5;	z_pT_Bin_Borders[4][12][2]  = 0.70;	z_pT_Bin_Borders[4][12][3]  = 0.61;	Phi_h_Bin_Values[4][12][0]  =  24;	Phi_h_Bin_Values[4][12][1]  = 241;	Phi_h_Bin_Values[4][12][2]  = 2412;
...
z_pT_Bin_Borders[4][18][0]  = 0.5;	z_pT_Bin_Borders[4][18][1]  = 0.43;	z_pT_Bin_Borders[4][18][2]  = 0.70;	z_pT_Bin_Borders[4][18][3]  = 0.61;	Phi_h_Bin_Values[4][18][0]  =  24;	Phi_h_Bin_Values[4][18][1]  = 385;	Phi_h_Bin_Values[4][18][2]  = 2556;
...
z_pT_Bin_Borders[4][24][0]  = 0.43;	z_pT_Bin_Borders[4][24][1]  = 0.38;	z_pT_Bin_Borders[4][24][2]  = 0.70;	z_pT_Bin_Borders[4][24][3]  = 0.61;	Phi_h_Bin_Values[4][24][0]  =  24;	Phi_h_Bin_Values[4][24][1]  = 529;	Phi_h_Bin_Values[4][24][2]  = 2700;
...
z_pT_Bin_Borders[4][30][0]  = 0.38;	z_pT_Bin_Borders[4][30][1]  = 0.33;	z_pT_Bin_Borders[4][30][2]  = 0.70;	z_pT_Bin_Borders[4][30][3]  = 0.61;	Phi_h_Bin_Values[4][30][0]  =  1;	Phi_h_Bin_Values[4][30][1]  = 673;	Phi_h_Bin_Values[4][30][2]  = 2844;
...
z_pT_Bin_Borders[4][36][0]  = 0.33;	z_pT_Bin_Borders[4][36][1]  = 0.26;	z_pT_Bin_Borders[4][36][2]  = 0.70;	z_pT_Bin_Borders[4][36][3]  = 0.61;	Phi_h_Bin_Values[4][36][0]  =  1;	Phi_h_Bin_Values[4][36][1]  = 794;	Phi_h_Bin_Values[4][36][2]  = 2965;
...
z_pT_Bin_Borders[7][1][0]   = 0.69;	z_pT_Bin_Borders[7][1][1]   = 0.58;	z_pT_Bin_Borders[7][1][2]   = 0.2;	z_pT_Bin_Borders[7][1][3]   = 0.05;	Phi_h_Bin_Values[7][1][0]   =  24;	Phi_h_Bin_Values[7][1][1]   = 0;	Phi_h_Bin_Values[7][1][2]   = 4366;
z_pT_Bin_Borders[7][2][0]   = 0.69;	z_pT_Bin_Borders[7][2][1]   = 0.58;	z_pT_Bin_Borders[7][2][2]   = 0.29;	z_pT_Bin_Borders[7][2][3]   = 0.2;	Phi_h_Bin_Values[7][2][0]   =  24;	Phi_h_Bin_Values[7][2][1]   = 24;	Phi_h_Bin_Values[7][2][2]   = 4390;
z_pT_Bin_Borders[7][3][0]   = 0.69;	z_pT_Bin_Borders[7][3][1]   = 0.58;	z_pT_Bin_Borders[7][3][2]   = 0.38;	z_pT_Bin_Borders[7][3][3]   = 0.29;	Phi_h_Bin_Values[7][3][0]   =  24;	Phi_h_Bin_Values[7][3][1]   = 48;	Phi_h_Bin_Values[7][3][2]   = 4414;
z_pT_Bin_Borders[7][4][0]   = 0.69;	z_pT_Bin_Borders[7][4][1]   = 0.58;	z_pT_Bin_Borders[7][4][2]   = 0.48;	z_pT_Bin_Borders[7][4][3]   = 0.38;	Phi_h_Bin_Values[7][4][0]   =  24;	Phi_h_Bin_Values[7][4][1]   = 72;	Phi_h_Bin_Values[7][4][2]   = 4438;
z_pT_Bin_Borders[7][5][0]   = 0.69;	z_pT_Bin_Borders[7][5][1]   = 0.58;	z_pT_Bin_Borders[7][5][2]   = 0.6;	z_pT_Bin_Borders[7][5][3]   = 0.48;	Phi_h_Bin_Values[7][5][0]   =  24;	Phi_h_Bin_Values[7][5][1]   = 96;	Phi_h_Bin_Values[7][5][2]   = 4462;
z_pT_Bin_Borders[7][6][0]   = 0.69;	z_pT_Bin_Borders[7][6][1]   = 0.58;	z_pT_Bin_Borders[7][6][2]   = 0.83;	z_pT_Bin_Borders[7][6][3]   = 0.6;	Phi_h_Bin_Values[7][6][0]   =  1;	Phi_h_Bin_Values[7][6][1]   = 120;	Phi_h_Bin_Values[7][6][2]   = 4486;
...
z_pT_Bin_Borders[11][1][0]  = 0.69;	z_pT_Bin_Borders[11][1][1]  = 0.52;	z_pT_Bin_Borders[11][1][2]  = 0.2;	z_pT_Bin_Borders[11][1][3]  = 0.05;	Phi_h_Bin_Values[11][1][0]  =  24;	Phi_h_Bin_Values[11][1][1]  = 0;	Phi_h_Bin_Values[11][1][2]  = 7475;
z_pT_Bin_Borders[11][2][0]  = 0.69;	z_pT_Bin_Borders[11][2][1]  = 0.52;	z_pT_Bin_Borders[11][2][2]  = 0.3;	z_pT_Bin_Borders[11][2][3]  = 0.2;	Phi_h_Bin_Values[11][2][0]  =  24;	Phi_h_Bin_Values[11][2][1]  = 24;	Phi_h_Bin_Values[11][2][2]  = 7499;
z_pT_Bin_Borders[11][3][0]  = 0.69;	z_pT_Bin_Borders[11][3][1]  = 0.52;	z_pT_Bin_Borders[11][3][2]  = 0.4;	z_pT_Bin_Borders[11][3][3]  = 0.3;	Phi_h_Bin_Values[11][3][0]  =  24;	Phi_h_Bin_Values[11][3][1]  = 48;	Phi_h_Bin_Values[11][3][2]  = 7523;
z_pT_Bin_Borders[11][4][0]  = 0.69;	z_pT_Bin_Borders[11][4][1]  = 0.52;	z_pT_Bin_Borders[11][4][2]  = 0.53;	z_pT_Bin_Borders[11][4][3]  = 0.4;	Phi_h_Bin_Values[11][4][0]  =  24;	Phi_h_Bin_Values[11][4][1]  = 72;	Phi_h_Bin_Values[11][4][2]  = 7547;
z_pT_Bin_Borders[11][5][0]  = 0.69;	z_pT_Bin_Borders[11][5][1]  = 0.52;	z_pT_Bin_Borders[11][5][2]  = 0.69;	z_pT_Bin_Borders[11][5][3]  = 0.53;	Phi_h_Bin_Values[11][5][0]  =  24;	Phi_h_Bin_Values[11][5][1]  = 96;	Phi_h_Bin_Values[11][5][2]  = 7571;
...
z_pT_Bin_Borders[15][1][0]  = 0.62;	z_pT_Bin_Borders[15][1][1]  = 0.49;	z_pT_Bin_Borders[15][1][2]  = 0.22;	z_pT_Bin_Borders[15][1][3]  = 0.05;	Phi_h_Bin_Values[15][1][0]  =  24;	Phi_h_Bin_Values[15][1][1]  = 0;	Phi_h_Bin_Values[15][1][2]  = 10029;
z_pT_Bin_Borders[15][2][0]  = 0.62;	z_pT_Bin_Borders[15][2][1]  = 0.49;	z_pT_Bin_Borders[15][2][2]  = 0.32;	z_pT_Bin_Borders[15][2][3]  = 0.22;	Phi_h_Bin_Values[15][2][0]  =  24;	Phi_h_Bin_Values[15][2][1]  = 24;	Phi_h_Bin_Values[15][2][2]  = 10053;
z_pT_Bin_Borders[15][3][0]  = 0.62;	z_pT_Bin_Borders[15][3][1]  = 0.49;	z_pT_Bin_Borders[15][3][2]  = 0.42;	z_pT_Bin_Borders[15][3][3]  = 0.32;	Phi_h_Bin_Values[15][3][0]  =  24;	Phi_h_Bin_Values[15][3][1]  = 48;	Phi_h_Bin_Values[15][3][2]  = 10077;
z_pT_Bin_Borders[15][4][0]  = 0.62;	z_pT_Bin_Borders[15][4][1]  = 0.49;	z_pT_Bin_Borders[15][4][2]  = 0.55;	z_pT_Bin_Borders[15][4][3]  = 0.42;	Phi_h_Bin_Values[15][4][0]  =  24;	Phi_h_Bin_Values[15][4][1]  = 72;	Phi_h_Bin_Values[15][4][2]  = 10101;
z_pT_Bin_Borders[15][5][0]  = 0.62;	z_pT_Bin_Borders[15][5][1]  = 0.49;	z_pT_Bin_Borders[15][5][2]  = 0.75;	z_pT_Bin_Borders[15][5][3]  = 0.55;	Phi_h_Bin_Values[15][5][0]  =  1;	Phi_h_Bin_Values[15][5][1]  = 96;	Phi_h_Bin_Values[15][5][2]  = 10125;
...
z_pT_Bin_Borders[15][10][0] = 0.49;	z_pT_Bin_Borders[15][10][1] = 0.4;	z_pT_Bin_Borders[15][10][2] = 0.75;	z_pT_Bin_Borders[15][10][3] = 0.55;	Phi_h_Bin_Values[15][10][0] =  24;	Phi_h_Bin_Values[15][10][1] = 193;	Phi_h_Bin_Values[15][10][2] = 10222;
...
z_pT_Bin_Borders[15][15][0] = 0.4;	z_pT_Bin_Borders[15][15][1] = 0.32;	z_pT_Bin_Borders[15][15][2] = 0.75;	z_pT_Bin_Borders[15][15][3] = 0.55;	Phi_h_Bin_Values[15][15][0] =  24;	Phi_h_Bin_Values[15][15][1] = 313;	Phi_h_Bin_Values[15][15][2] = 10342;
...
z_pT_Bin_Borders[15][20][0] = 0.32;	z_pT_Bin_Borders[15][20][1] = 0.27;	z_pT_Bin_Borders[15][20][2] = 0.75;	z_pT_Bin_Borders[15][20][3] = 0.55;	Phi_h_Bin_Values[15][20][0] =  1;	Phi_h_Bin_Values[15][20][1] = 433;	Phi_h_Bin_Values[15][20][2] = 10462;
...
z_pT_Bin_Borders[15][25][0] = 0.27;	z_pT_Bin_Borders[15][25][1] = 0.22;	z_pT_Bin_Borders[15][25][2] = 0.75;	z_pT_Bin_Borders[15][25][3] = 0.55;	Phi_h_Bin_Values[15][25][0] =  1;	Phi_h_Bin_Values[15][25][1] = 530;	Phi_h_Bin_Values[15][25][2] = 10559;
...
z_pT_Bin_Borders[17][1][0]  = 0.62;	z_pT_Bin_Borders[17][1][1]  = 0.44;	z_pT_Bin_Borders[17][1][2]  = 0.19;	z_pT_Bin_Borders[17][1][3]  = 0.05;	Phi_h_Bin_Values[17][1][0]  =  24;	Phi_h_Bin_Values[17][1][1]  = 0;	Phi_h_Bin_Values[17][1][2]  = 11142;
z_pT_Bin_Borders[17][2][0]  = 0.62;	z_pT_Bin_Borders[17][2][1]  = 0.44;	z_pT_Bin_Borders[17][2][2]  = 0.28;	z_pT_Bin_Borders[17][2][3]  = 0.19;	Phi_h_Bin_Values[17][2][0]  =  24;	Phi_h_Bin_Values[17][2][1]  = 24;	Phi_h_Bin_Values[17][2][2]  = 11166;
z_pT_Bin_Borders[17][3][0]  = 0.62;	z_pT_Bin_Borders[17][3][1]  = 0.44;	z_pT_Bin_Borders[17][3][2]  = 0.37;	z_pT_Bin_Borders[17][3][3]  = 0.28;	Phi_h_Bin_Values[17][3][0]  =  24;	Phi_h_Bin_Values[17][3][1]  = 48;	Phi_h_Bin_Values[17][3][2]  = 11190;
z_pT_Bin_Borders[17][4][0]  = 0.62;	z_pT_Bin_Borders[17][4][1]  = 0.44;	z_pT_Bin_Borders[17][4][2]  = 0.45;	z_pT_Bin_Borders[17][4][3]  = 0.37;	Phi_h_Bin_Values[17][4][0]  =  24;	Phi_h_Bin_Values[17][4][1]  = 72;	Phi_h_Bin_Values[17][4][2]  = 11214;
z_pT_Bin_Borders[17][5][0]  = 0.62;	z_pT_Bin_Borders[17][5][1]  = 0.44;	z_pT_Bin_Borders[17][5][2]  = 0.55;	z_pT_Bin_Borders[17][5][3]  = 0.45;	Phi_h_Bin_Values[17][5][0]  =  24;	Phi_h_Bin_Values[17][5][1]  = 96;	Phi_h_Bin_Values[17][5][2]  = 11238;
z_pT_Bin_Borders[17][6][0]  = 0.62;	z_pT_Bin_Borders[17][6][1]  = 0.44;	z_pT_Bin_Borders[17][6][2]  = 0.73;	z_pT_Bin_Borders[17][6][3]  = 0.55;	Phi_h_Bin_Values[17][6][0]  =  24;	Phi_h_Bin_Values[17][6][1]  = 120;	Phi_h_Bin_Values[17][6][2]  = 11262;
