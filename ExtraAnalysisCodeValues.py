...
auto Polygon_Layers = std::map<std::string, std::vector<std::pair<double, double>>>{
    ...
    {"Layer_6__pip", {{-83,  0}, {-80,   -6}, {-60,  -18}, {-20,  -37}, {20,  -57}, {35,   0},  {20,    56}, {-20,  37}, {-60,  18}, {-80,   8}, {-83,   0}}},
    {"Layer_18_pip", {{-125, 0}, {-125,  -7}, {-118, -8},  {-80,  -32}, {-50, -47}, {0,  -73},  {30,   -89}, {55,    0}, {32,   91}, {0,    74}, {-80,  33}, {-114,  13}, {-119,  8}, {-124,  8}, {-125,  0}}},
    {"Layer_36_pip", {{-155, 0}, {-150, -10}, {-125, -33}, {-100, -49}, {-50, -75}, {0,  -102}, {74,  -144}, {76,  -90}, {94,    0}, {76,  100}, {72,  145}, {-10,  100}, {-50,  78}, {-110, 47}, {-142, 20}, {-147, 15}, {-150, 12}, {-154, 10}, {-155, 0}}}
};
