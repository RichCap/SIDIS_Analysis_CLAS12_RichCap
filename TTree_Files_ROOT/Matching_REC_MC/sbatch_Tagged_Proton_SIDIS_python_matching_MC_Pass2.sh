#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=TP_mdf_TTree_11_8_2024_Run1_New_TTree_V2_SIDIS
...
srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/TTree_create_ROOT_epip_SIDIS.py mdf_sidis_Pro ${FILES[$SLURM_ARRAY_TASK_ID]}
