#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=V_AngleOnlyZerothOrder_12_15_2025_running_batch_jobs
...
Reran with Valerii's Binning. Increased memory request to '4GB' instead of '3GB'. Ran with improved weight normalization and with sequential mode running simultaneously."
