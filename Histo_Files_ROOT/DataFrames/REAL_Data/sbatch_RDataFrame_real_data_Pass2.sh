#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=FC14_rdf_DF_7_28_2025_Run1_Sector_Tests_V2
...
/w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/./dataframe_makeROOT_epip_SIDIS.py -s rdf -f ${FILES[$SLURM_ARRAY_TASK_ID]}
