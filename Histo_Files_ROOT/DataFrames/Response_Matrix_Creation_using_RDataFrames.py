...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Makes Response Matricies for Unfolding (based on using_RDataFrames_python.py)", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    parser.add_argument('-nrdf', '--num-rdf-files',
                        type=int,
                        default=5,
                        help='Number of rdf RDataFrames to be included.')
    parser.add_argument('-nMC', '--num-MC-files',
                        type=int,
                        default=1,
    ...
    parser.add_argument('-NoEvGen', '--Do_not_use_EvGen',
                        action='store_true', 
    ...
    parser.add_argument('-MR', '--make_root',
                        action='store_true',
    ...
    parser.add_argument('-nohpp', '--do_not_use_hpp',
                        action='store_true',
    ...
    parser.add_argument('-r', '--root',
                        type=str,
                        default="SIDIS_epip_All_File_Types_from_RDataFrames.root", 
    ...
    parser.add_argument('-hpp', '--hpp_input_file',
                        type=str,
    ...
    # parser.add_argument('-hppOut', '--hpp_output_file',
    #                     type=str,
    #                     default="generated_acceptance_weights.hpp", 
