...
/w/ceph24/hallb/clas12/users/richcap/SIDIS_Analysis_CLAS12_RichCap/Histo_Files_ROOT/DataFrames/Response_Matrix_Creation_using_RDataFrames.py --batch_id ${BATCH_ID} --data_root work_b -cnR cut_Complete_SIDIS_MM_None -cnM cut_Complete_SIDIS_MM_None --z_axis_2D z_Bins --make_root --make_2D --fast --run_rho_weight --matching_criteria Bank -n Only_2D_rho0_Normalization_Creation_Final_Thesis_Bank_Final_Thesis_Files_Batch${BATCH_PAD} -r /lustre24/expphy/volatile/clas12/richcap/RDataFrames_to_Delete_from_work/Only_2D_rho0_Normalization_Creation_Final_Thesis_Bank_Final_Thesis_Files_09_05_2026/SIDIS_epip_Response_Matrices_from_RDataFrames.root --make_2D_rho_normalization_only --run_rho_weight
