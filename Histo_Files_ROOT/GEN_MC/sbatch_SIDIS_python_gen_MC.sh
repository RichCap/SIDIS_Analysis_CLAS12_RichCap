#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=MC_GEN_Multi_Dimension_Unfold_V3_SIDIS_histo_3_8_2023
...
srun python /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/makeROOT_epip_SIDIS_histos_new.py gdf ${FILES[$SLURM_ARRAY_TASK_ID]}
