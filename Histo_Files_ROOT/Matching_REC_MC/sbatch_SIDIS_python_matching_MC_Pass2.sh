#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=FC1_NS_mdf_SIDIS_8_14_2024_Run1_New_Fiducial_Cut_Test_V6_SIDIS
...
# Above is for (mdf_NewP2 - As of 8/8/2024) #SBATCH --array=0-73
# Normally requested time: --time=14:00:00

srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/makeROOT_epip_SIDIS_histos_new.py mdf_sidis_NewP2_NS_FC1 ${FILES[$SLURM_ARRAY_TASK_ID]}
