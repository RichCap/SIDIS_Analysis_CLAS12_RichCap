#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=NS_NP2_mdf_SIDIS_7_29_2024_Run1_New_Fiducial_Cut_Test_V2_SIDIS
...
# Above is for (mdf_NewP2 - As of 7/29/2024) #SBATCH --array=0-63
# Normally requested time: --time=14:00:00

srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/makeROOT_epip_SIDIS_histos_new.py mdf_sidis_NewP2_NS ${FILES[$SLURM_ARRAY_TASK_ID]}
