#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=FC5_NS_mdf_SIDIS_8_22_2024_Run1_New_Fiducial_Cut_Test_V7_SIDIS
...
srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/makeROOT_epip_SIDIS_histos_new.py mdf_sidis_NewP2_NS_FC5 ${FILES[$SLURM_ARRAY_TASK_ID]}
