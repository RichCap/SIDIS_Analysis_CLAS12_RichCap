#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=EvGen_mdf_9_13_2025_R1_FC14_Acceptance_Tests_V2
...
srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/makeROOT_epip_SIDIS_histos_new.py mdf_sidis_NewP2_FC_14_no_smear_EvGen ${FILES[$SLURM_ARRAY_TASK_ID]}
