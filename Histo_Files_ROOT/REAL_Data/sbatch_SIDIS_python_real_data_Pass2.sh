#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=sFC_11_rdf_SIDIS_9_9_2024_Run1_Only_Cut_Tests_V2_SIDIS
...
srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/makeROOT_epip_SIDIS_histos_new.py rdf_sidis_NewP2_Small_FC_11 ${FILES[$SLURM_ARRAY_TASK_ID]}
