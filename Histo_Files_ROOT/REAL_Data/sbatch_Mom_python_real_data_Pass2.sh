#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=P2_rdf_Mom_11_4_2024_Run1_Update_Cors_and_Cuts_V1_Mom
...
srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/makeROOT_epip_SIDIS_histos_new.py rdf_mom_NewP2_FC_14 ${FILES[$SLURM_ARRAY_TASK_ID]}
