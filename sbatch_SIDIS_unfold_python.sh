#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=RooUnfold_P2_Sector_Integrated_Tests_V2_R6_eSectors_5_5_2025
...
# srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/RooUnfold_SIDIS_richcap.py smear_no_stat_TP $SLURM_ARRAY_TASK_ID
