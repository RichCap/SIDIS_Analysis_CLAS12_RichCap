#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --job-name=P2_RooUnfold_5D_Unfold_Test_V5_5_14_2024_Run1
...
srun python3 /w/hallb-scshelf2102/clas12/richcap/SIDIS_Analysis/RooUnfold_SIDIS_richcap.py no_smear_no_txt $SLURM_ARRAY_TASK_ID
